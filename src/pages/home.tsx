    ...
    return (
        <Stack width={['100%', '100%', '100%', '100%']}>
            ...
            <Stack
                ...
                width="100%">
                <Stack justify="flex-start" align="flex-start" flex="1" alignSelf="stretch">
                    <Stack
                        direction="row"
                        justify="flex-start"
                        align="center"
                                ...
                                <Stack
                                    ...
                                    <Stack
                                        ...
                                        <Stack
                                            ...
                                            backgroundSize="100%"
                                            backgroundRepeat={'no-repeat'}
                                            backgroundPosition={'right bottom'}></Stack>
                                    </Stack>
                                    <Stack
                                        borderRadius="35px"
                                        padding="10px"
                            ...
                            <Stack
                                ...
                                <Stack
                                    ...
                                    <Button borderRadius="100px">
                                        <Circle
                                            size="8px"
                                            background={isCeremonyOngoing ? 'green' : '#EF4444'}
                                            marginRight="5%"
                                        />
                                        <Text
                                            lineHeight="1.33"
                        ...
                        <Stack justify="flex-start" align="flex-start" spacing="0px">
                            ...
                            <Stack
                                ...
                                <Stack
                                    ...
                                    backgroundRepeat="no-repeat"></Stack>
                            </Stack>
                        </Stack>
                    </Stack>
                </Stack>
