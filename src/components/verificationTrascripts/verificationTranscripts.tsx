...
import { MaciBlack, MaciLightBase, MaciLightYellow, MaciWhite, MaciYellow } from '../../utils/colors'
                            ...
                            <Tr>
                                ...
                                <Tooltip label='The hash of the contribution'>
                                    <Th 
                                        ...
                                        fontSize="16px"
                                        letterSpacing="0.02em"
                                        color={MaciBlack}>Contribution Hash</Th>
                                </Tooltip> 
                                <Tooltip 
                                label='A text file hosted on S3 with the transcript of the contribution verification'>
                                    <Th    
                                    lineHeight="1.5"
                                    fontWeight="bold"
                                    fontSize="16px"
                                    letterSpacing="0.02em"
                                    color={MaciBlack}>Verification Transcript</Th>
                                </Tooltip>
                        ...
                        <Tbody>
                            {
                                ...
                                transcripts.filter(checkByCircuit).filter(checkSearch).slice(startIndex, endIndex).map((transcript: ITranscript, index: number) => {
                                    return (
                                        <Tr cursor='pointer' onClick={() => onOpen(index)} key={index}>
                                            <Td>
                                                <Text
                                                color={MaciBlack}
                                                >
                                            ...
                                            <Td>
                                                ...
                                                color={MaciBlack}
                                                >
                                                {getEllipsisTxt(transcript.contributionHash, 10)}
                                                </Text>
                                            </Td>  
                                            <Td>
                                                <Text
